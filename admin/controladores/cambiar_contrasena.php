...
<html>
    ...
    <body>
        ...
        <?php
            ...
            $sqlContrasena1 = "SELECT * FROM usuarios WHERE usu_codigo=$codigo";
            ...
            if ($result->num_rows > 0){
                ...
                $sqlContrasena2 = "UPDATE usuarios SET usu_password=MD5($contrasena2), usu_fecha_modificacion='$fecha' WHERE usu_codigo=$codigo";
