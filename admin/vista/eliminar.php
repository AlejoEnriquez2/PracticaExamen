...
<html>
    ...
    <body>
        ...
        ?>
                    <form class="box" method="POST" action="/PracticaExamen/admin/controladores/eliminar.php?codigo_admin=<?php echo $codigo_admin ?>">
                        ...
                        <input type="button" id="cancelar" name="cancelar" value="Cancelar"  class="boton">
                    </form>
        <?php
                }
            }else{
